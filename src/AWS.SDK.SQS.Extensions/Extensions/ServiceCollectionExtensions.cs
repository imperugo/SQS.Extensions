...
using AWS.SDK.SQS.Extensions.Implementations;
...
/// <summary>
/// A set of extension methods that help you to configure AWS.SDK.SQS.Extensions into your dependency injection
/// </summary>
public static class ServiceCollectionExtensions
{
    ...
    /// <summary>
    /// Add AWS.SDK.SQS.Extensions services to the DI with the default configuration
    /// </summary>
    ...
    /// <summary>
    /// Add AWS.SDK.SQS.Extensions services to the DI with custom serialization
    /// </summary>
    /// <param name="serviceCollection">The service collection.</param>
    /// <param name="configuration">The AWS Configuration.</param>
    ...
    /// <summary>
    /// Add AWS.SDK.SQS.Extensions services to the DI with custom Queue helper
    /// </summary>
    /// <param name="serviceCollection">The service collection.</param>
    /// <param name="configuration">The AWS Configuration.</param>
    ...
    /// <summary>
    /// Add AWS.SDK.SQS.Extensions services to the DI
    /// </summary>
    /// <param name="serviceCollection">The service collection.</param>
    /// <param name="configuration">The AWS Configuration.</param>
    /// <typeparam name="TQueueHelper">The queue helper implementation type.</typeparam>
