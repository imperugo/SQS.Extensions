...
public interface ISqsDispatcher
{
    ...
    /// <typeparam name="T">The type of the expected object.</typeparam>
    /// <returns>The response from the SendMessage service method, as returned by SQS.</returns>
    Task QueueAsync<T>(List<T> obj, string queueName, CancellationToken cancellationToken = default);
    ...
    /// </remarks>
    /// <returns>The response from the SendMessage service method, as returned by SQS.</returns>
    Task QueueAsync<T>(List<T> obj, string queueName, int delaySeconds, CancellationToken cancellationToken = default);
